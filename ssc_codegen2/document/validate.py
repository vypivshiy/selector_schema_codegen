...
from ssc_codegen.queries import validate_xpath_query
...
from ssc_codegen2.utils.selector_validators import validate_css_query, validate_xpath_query
...
class DocumentOpAssert(BaseDocument):
    ...
    def assert_xpath(self, query: str, msg: str = ''):
        ...
        self._add_expr(TokenType.OP_ASSERT_XPATH,
                       args=(query, msg))

        return self

    def assert_eq(self, item: str, msg: str = ''):
        self._test_type_state_expr(TypeVariableState.STRING, TypeVariableState.NONE)
    ...
    def assert_in(self, item: str, msg: str = ''):
        ...
        self._add_expr(TokenType.OP_ASSERT_CONTAINS,
                       args=(item, msg))
        return self
    ...
    def assert_re(self, pattern: str, msg: str = ''):
        ...
        self._add_expr(TokenType.OP_ASSERT_RE_MATCH,
                       args=(pattern, msg))
        return self
