...
T_Item4 = TypedDict("T_Item4", {"items": List[str]})
T_Item3 = TypedDict("T_Item3", {"items": List[str], "b_text": str})
T_Item2 = TypedDict("T_Item2", {"items": List[str], "href": str})
T_Item1 = TypedDict("T_Item1", {"items": List[str], "href": str})
T_ItemRec3 = TypedDict(
    "T_ItemRec3", {"item_rec4": T_Item4, "items": List[str], "b_text": str}
)
T_ItemRec2 = TypedDict(
    "T_ItemRec2", {"item_rec3": T_ItemRec3, "items": List[str], "href": str}
)
T_ItemRec1 = TypedDict(
    "T_ItemRec1", {"item_rec2": T_ItemRec2, "items": List[str], "href": str}
)
T_Main = TypedDict(
    "T_Main",
    {
