...
- конвертировать xpath в css только для простых запросов: например, в css нет аналога `contains` из xpath и тд
...
- Есть 3 типа данных и их разделение условно: 
...
| Тип      | Описание                                                            |
|----------|---------------------------------------------------------------------|
| SELECTOR | инстанс класса, из которого вызываются css/xpath селекторы. Это первый аргумент |
| TEXT     | строка                                                              |
| ARRAY    | динамический массив строк.                                          |
...
- retranslate regex expressions. Eg: `\d` в `[0-9]`
