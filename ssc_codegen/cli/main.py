...
def json_to_schema(
    ...
    json_start_path: Annotated[
        str,
        Option("--json-path", "-jp", help="optional json_start_path target"),
    ] = "",
) -> None:
    ...
    code = convert_json_to_schema_code(
        jsn, entrypoint_name, json_start_path=json_start_path
    )
    out.write_text(
